...
import { FileSpreadsheet, Loader2, Mail, Lock, User, AlertCircle, CheckCircle } from 'lucide-react';
import { toast } from 'sonner';

export default function Signup() {
  const [, setLocation] = useLocation();
  const { signUp, signInGoogle, loading: authLoading } = useSupabaseAuth();
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription>Get started with 3 free conversions per day</CardDescription>
        </CardHeader>
